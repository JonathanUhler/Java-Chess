...
public class CrazyPane extends JLayeredPane {
	...
	public CrazyPane(Piece.Color playerColor, PiecePane piecePane) {
	    if (playerColor == null)
    ...
    /**
	 * Returns the player color of this {@code CrazyPane}. This determines which
	 * perspective the pane displays.
	 *
	 * @return the player color of this {@code CrazyPane}.
	 */
	...
	public void adapterEvent(int pieceRow, Coordinate endTile) {
		...
		Map<String, String> command = CrazyServer.cmdPlace(pieceType, endTile);
