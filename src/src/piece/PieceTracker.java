...
public class PieceTracker implements Cloneable {
    ...
    private int[] tilesWithPieces; // A list of tiles that already have pieces on them
    private int[] tileMap; // Allows the ability to transition from a tile's index to the index of that tile in the tilesWithPieces array (eg, given tileIndex, where does tileIndex correspond in the tilesWithPieces array?)
    private int pieceCount; // Number of existing pieces
    private int maxPieces; // The maximum number of pieces of this type
