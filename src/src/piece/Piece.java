...
public class Piece {
    ...
    private static final int typeAnd = 0b00111; // Maximum value of a piece type
    private static final int colorAnd = 0b01000 | 0b10000; // Combination of white and black value
